...
# Install packages
RUN apt update && apt upgrade -y; apt -y install iputils-ping iputils-tracepath nmap netcat telnet mtr-tiny ipcalc podman skopeo buildah curl wget vim jq git gnupg2 dnsutils postgresql-client mysql-client; rm -rf /var/cache/apt
